...
\multicolumn{1}{p{-0.04in}}{} & 
\multicolumn{1}{p{1.63in}}{\Centering {А.В. Панченко}} \\
\hhline{~-~-~-}
%row no:2
...
\noindent\textbf{Цель:}
\textbf{} Знакомство с системой контроля версий git и сервисом GitHub  

\noindent\textbf{Текст задания:}

\section*{Задание 1}
\textbf{Цель:} Определить свои цели и задачи на текущий семестр.  
\textbf{Шаги:} Создать файл `goals.md` на GitHub, описать опыт и цели, а также задачи на семестр.

\section*{Задание 2}
\textbf{Цель:} Освоить работу с Git из командной строки.  
\textbf{Шаги:} Клонировать репозиторий, создать файл `info.md`, записать свои данные, закоммитить и запушить изменения.

\section*{Задание 3}
\textbf{Цель:} Соблюсти формальности.  
\textbf{Шаги:} Подготовить отчет в формате PDF с использованием LaTeX, включить в него титульный лист, текст задания и результат выполнения заданий.

\noindent\textbf{Результат выполнения задания:}

\newpage

\noindent\textbf{Содержимое файла `goals.md`:}

\section*{Мой опыт}
Я создавал простые сайты-визитки, используя языки разметки HTML и CSS. Также я разрабатывал небольшие программы и одну крупную программу для компании Протей. Разумеется, когда я работал над этой программой, я был частью команды разработчиков и сотрудничал с другими специалистами.

\section*{Мои цели}
\textbf{Цели в рамках данного курса:}
\begin{itemize}
    \item Больше узнать о работе Git.
    \item Получше ознакомиться с работой GitHub.
\end{itemize}

\textbf{Задачи для выполнения целей:}
\begin{itemize}
    \item Изучение документации по Git.
    \item Просмотр видеороликов по Git.
    \item Выполнять задания поставленные преподавателем.
\end{itemize}

\newpage

\noindent\textbf{Содержимое файла `info.md`:}

\begin{itemize}
    \item Панченко Андрей Викторович
    \item MacOS
    \item 06.09.2024 19:19
\end{itemize}

\newpage

\section*{Вывод:}
Я научился пользоваться сервисами GitHub и системой контроля версий git. Так же научился создавать отчеты в программе LaTex.
