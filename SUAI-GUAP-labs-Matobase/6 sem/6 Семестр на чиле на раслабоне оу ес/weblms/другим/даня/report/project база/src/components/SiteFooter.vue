...
<template>
  <div class="footer">
    <div class="footer-content">
      <p>&copy; 2025 Проект "Характеристики линий связи". Все права защищены.</p>
...
/* Футер с прямоугольником с закругленными углами */
.footer {
  background-color: transparent; /* Без фона на всю ширину */
  color: white;
  padding: 20px 0;
  text-align: center;
...
.footer-content {
  background-color: #333; /* Цвет фона прямоугольника */
  color: white;
  padding: 20px;
